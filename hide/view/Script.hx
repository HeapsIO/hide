...
class Script extends FileView {
	...
	static var _ = {
		Extension.registerExtension(Script,["js","hx"],{ icon : "file-code-o", name: "Script" });
		Extension.registerExtension(Script,["xml","html"],{ icon : "code", name: "Script" });
		Extension.registerExtension(Script,["json"],{ icon : "gears", name: "Script" });
	};
