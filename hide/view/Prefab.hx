...
class Prefab extends hide.view.FileView {
	...
	**/
	...
	public static function cleanupPrefabCdb(prefab: hrt.prefab.Prefab, optionalBackup: cdb.Database.OptionalBackup) {
		...
		if (cdbType != null) {
			...
			cdb.Database.cleanupOptionalLines([prefab.props], sheet, optionalBackup);
		}
	...
	override function save() {
		...
		cdb.Database.restoreOptionals(backup);
