...
import hrt.prefab2.vlm.LightProbe.LightProbeObject;
...
class ProbeBaker {
	...
	function convertEnvIntoSH_CPU( env : h3d.mat.Texture, order : Int ) : hrt.prefab2.vlm.SphericalHarmonic {
		var coefCount = order * order;
		var sphericalHarmonic = new hrt.prefab2.vlm.SphericalHarmonic(order);
		var face : hxd.Pixels;
		var weightSum = 0.0;
