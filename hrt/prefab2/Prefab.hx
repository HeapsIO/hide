...
class Prefab {
    ...
    public function getObject3d() : h3d.scene.Object {
        var p = this;
        while (p != null) {
            var l = p.getLocal3d();
            if (l != null)
    ...
    @:noCompletion
    final function _make_internal(?root: Prefab = null, ?o2d: h2d.Object = null, ?o3d: h3d.scene.Object = null) : Prefab {
    ...
    // made
    function onMake(?o2d: h2d.Object = null, ?o3d: h3d.scene.Object = null) : Void {
    ...
    function onMakeInstance(?o2d: h2d.Object = null, ?o3d: h3d.scene.Object = null) : Void {
	...
	**/
    ...
    static function copyShallow(source:Dynamic, dest:Dynamic, useProperty:Bool, copyNull:Bool, props:Array<PrefabField>) {
