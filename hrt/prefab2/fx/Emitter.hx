...
import hrt.prefab2.l3d.Polygon;
...
@:allow(hrt.prefab2.fx.ParticleInstance)
@:allow(hrt.prefab2.fx.Emitter)
class EmitterObject extends h3d.scene.Object {
    ...
    function makeShaderInstance(prefab: hrt.prefab2.Shader) {
...
class Emitter extends Object3D {
    ...
    override function updateInstance(?propName : String ) {
        ...
        function makeColor(scope: Prefab, name: String) {
            var curves = hrt.prefab2.Curve.getCurves(scope, name);
            if(curves == null || curves.length == 0)
                return null;
            return hrt.prefab2.Curve.getColorValue(curves);
        }
