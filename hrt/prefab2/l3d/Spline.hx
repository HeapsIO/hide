...
class SplinePoint extends Object3D {
	...
	override function edit(ctx : hide.prefab2.EditContext) {
		super.edit(ctx);
		if( spline.editor == null ) {
			spline.editor = new hide.prefab2.SplineEditor(spline, ctx.properties.undo);
		}
...
class Spline extends Object3D {
	...
	#if editor
	public var editor : hide.prefab2.SplineEditor;
	#end
	...
	override function edit( ctx : hide.prefab2.EditContext ) {
		...
		if( editor == null ) {
			editor = new hide.prefab2.SplineEditor(this, ctx.properties.undo);
		}
