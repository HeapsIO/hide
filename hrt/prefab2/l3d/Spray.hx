...
@:access(hrt.prefab2.l3d.MeshSpray)
class SprayObject extends h3d.scene.Object {
...
class Spray extends Object3D {
	...
	var wasEdited = false;
	var previewItems : Array<hrt.prefab2.Prefab> = [];
	var sprayedItems : Array<hrt.prefab2.Prefab> = [];
	...
	function previewItemsAround(ectx : hide.prefab2.EditContext, point : h3d.col.Point) {
		...
		for (child in children) {
			var item = child.to(hrt.prefab2.Object3D);
