...
class Layer2DRFX extends hrt.prefab2.rfx.RendererFX {
...
@:allow(hrt.prefab2.l3d)
class Layers2D extends hrt.prefab2.Object3D {
	...
	var sceneEditor : hide.comp2.SceneEditor;
	var editorCtx : hide.prefab2.EditContext;
	...
	function setupRfx( ectx : hide.prefab2.EditContext, b : Bool ) {
		if ( ectx == null )
			return;
		if ( b ) {
			if ( rfx == null ) {
	...
	static var _ = hrt.prefab2.Prefab.register("layers2D", Layers2D);
}
