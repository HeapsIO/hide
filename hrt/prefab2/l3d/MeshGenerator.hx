...
class MeshGenerator extends Object3D {
	...
	function generate( ctx : hide.prefab2.EditContext, mp : MeshPart, maxDepth : Int, curDepth : Int) {
	...
	function getThumbnailPath( ctx : hide.prefab2.EditContext, meshPath : String ) : String {
	...
	function fillSelectMenu( ctx : hide.prefab2.EditContext, select : hide.Element, socket : Socket ) {
		for( f in filter ) {
	...
	function createMenu( ctx : hide.prefab2.EditContext, mp : MeshPart ) {
