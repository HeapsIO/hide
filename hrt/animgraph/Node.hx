...
#end
{
	...
	**/
	...
	// If not present in the child classes, will be
	// autogenerated to return hrt.animgraph.Macros.getInputs();
	public function getInputs() : Array<NodeInputInfo> {
		return [];
	}

	// If not present in the child classes, will be
	// autogenerated to return hrt.animgraph.Macros.getOutputs();
